...
### Interactomes
# Human
df_apid = pd.read_csv(human_intact_dir / 'raw_data' / 'apid_human_2_no_int_species_04_05_2020.txt', sep='\t')
df_apid = df_apid[['UniprotID_A', 'UniprotID_B']]

df_huri = pd.read_csv(human_intact_dir / 'raw_data' / 'HuRI_04_05_2020.psi', sep='\t', header=None)
...
# save interactome
df_human.to_csv(human_intact_dir / 'human_interactome.edgelist', index=False, header=False)
